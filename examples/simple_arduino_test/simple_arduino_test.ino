...
IPAddress ip(192, 168, 1, 134); // local ip
IPAddress sendIP(192, 168, 1, 106); // remote ip
...
void loop()
{
  ...
  send_data.values[1] = (float) recv_data.values[1];
  send_data.values[2] = (float) recv_data.values[2];
  send_data.values[3] = (float) recv_data.values[3];
